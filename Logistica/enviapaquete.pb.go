...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enviapaquete_proto_msgTypes[0]
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_enviapaquete_proto_rawDescGZIP(), []int{0}
}
...
var File_enviapaquete_proto protoreflect.FileDescriptor

var file_enviapaquete_proto_rawDesc = []byte{
	0x0a, 0x12, 0x65, 0x6e, 0x76, 0x69, 0x61, 0x70, 0x61, 0x71, 0x75, 0x65, 0x74, 0x65, 0x2e, 0x70,
	...
	0x73, 0x65, 0x6e, 0x64, 0x70, 0x61, 0x71, 0x75, 0x65, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_enviapaquete_proto_rawDescOnce sync.Once
	file_enviapaquete_proto_rawDescData = file_enviapaquete_proto_rawDesc
)

func file_enviapaquete_proto_rawDescGZIP() []byte {
	file_enviapaquete_proto_rawDescOnce.Do(func() {
		file_enviapaquete_proto_rawDescData = protoimpl.X.CompressGZIP(file_enviapaquete_proto_rawDescData)
	})
	return file_enviapaquete_proto_rawDescData
}

var file_enviapaquete_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enviapaquete_proto_goTypes = []interface{}{
...
func init() { file_enviapaquete_proto_init() }
func file_enviapaquete_proto_init() {
	if File_enviapaquete_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enviapaquete_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enviapaquete_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_enviapaquete_proto_goTypes,
		DependencyIndexes: file_enviapaquete_proto_depIdxs,
		MessageInfos:      file_enviapaquete_proto_msgTypes,
	}.Build()
	File_enviapaquete_proto = out.File
	file_enviapaquete_proto_rawDesc = nil
	file_enviapaquete_proto_goTypes = nil
	file_enviapaquete_proto_depIdxs = nil
}
