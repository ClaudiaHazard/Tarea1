...
func (x *Message) Reset() {
	*x = Message{}
	if protoimpl.UnsafeEnabled {
		mi := &file_enviaorden_proto_msgTypes[0]
...
func (*Message) Descriptor() ([]byte, []int) {
	return file_enviaorden_proto_rawDescGZIP(), []int{0}
}
...
var File_enviaorden_proto protoreflect.FileDescriptor

var file_enviaorden_proto_rawDesc = []byte{
...
var (
	file_enviaorden_proto_rawDescOnce sync.Once
	file_enviaorden_proto_rawDescData = file_enviaorden_proto_rawDesc
)

func file_enviaorden_proto_rawDescGZIP() []byte {
	file_enviaorden_proto_rawDescOnce.Do(func() {
		file_enviaorden_proto_rawDescData = protoimpl.X.CompressGZIP(file_enviaorden_proto_rawDescData)
	})
	return file_enviaorden_proto_rawDescData
}

var file_enviaorden_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enviaorden_proto_goTypes = []interface{}{
...
func init() { file_enviaorden_proto_init() }
func file_enviaorden_proto_init() {
	if File_enviaorden_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_enviaorden_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_enviaorden_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_enviaorden_proto_goTypes,
		DependencyIndexes: file_enviaorden_proto_depIdxs,
		MessageInfos:      file_enviaorden_proto_msgTypes,
	}.Build()
	File_enviaorden_proto = out.File
	file_enviaorden_proto_rawDesc = nil
	file_enviaorden_proto_goTypes = nil
	file_enviaorden_proto_depIdxs = nil
}
...
// EnviaOrdenServiceClient is the client API for EnviaOrdenService service.
//
...
func NewEnviaOrdenServiceClient(cc grpc.ClientConnInterface) EnviaOrdenServiceClient {
...
var _EnviaOrdenService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "enviaorden.EnviaOrdenService",
